...
public class ThunderBurst extends ArcaneSpell {
    ...
    public boolean cast(World world, EntityPlayer entityPlayer, EnumHand enumHand, int i, SpellModifiers spellModifiers) {
        if (!world.isRemote) {
            ...
            EntityUtils.playSoundAtPlayer(entityPlayer, WizardrySounds.ENTITY_LIGHTNING_SIGIL_TRIGGER, 1.0f, 1.0f);
            EntityUtils.playSoundAtPlayer(entityPlayer, WizardrySounds.ENTITY_HAMMER_EXPLODE, 2.0f, 1.0f);
