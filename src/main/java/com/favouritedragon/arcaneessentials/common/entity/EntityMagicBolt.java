...
public abstract class EntityMagicBolt extends Entity implements IProjectile, IEntityAdditionalSpawnData {
	 ...
	 */
	public EntityMagicBolt(World world, EntityLivingBase caster, Entity target, float speed, float aimingError,
	 ...
	 */
	public EntityMagicBolt(World world, EntityLivingBase caster, float speed, float damageMultiplier){
		super(world);
		this.shootingEntity = new WeakReference<EntityLivingBase>(caster);
		this.damageMultiplier = damageMultiplier;
	...
	/** Called each tick when the projectile is in the air. Override to add particles and such. */
	public void tickInAir(){
	}

	/** Called when the projectile hits an entity. Override to add potion effects and such. */
	public void onEntityHit(EntityLivingBase entityHit){
	}

	/** Called when the projectile hits a block. Override to add sound effects and such. */
