...
public class NBTUtils {
	...
	public static <T> List<T> readListFromNBT(NBTTagCompound nbt, String key,
											  NBTInterfaceUtils.CreateFromNBT<T> creator, Object... extraData) {
	...
	public static <T> void writeListToNBT(NBTTagCompound nbt, String key,
										  NBTInterfaceUtils.WriteToNBT<T> writer, List<T> list, Object... extraData) {
	 ...
	 */
	public static <K, V> Map<K, V> readMapFromNBT(NBTTagCompound nbt, NBTInterfaceUtils.MapUser<K, V> mapUser, String key,
	 ...
	 * @param map
	 */
	public static <K, V> void writeMapToNBT(NBTTagCompound nbt, Map<K, V> map, NBTInterfaceUtils.MapUser<K, V> mapUser,
											String key) {
		NBTTagList nbtList = new NBTTagList();
